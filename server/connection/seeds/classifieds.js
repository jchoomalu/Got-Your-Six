  ...
  "posts": [
    {
      ...
      "description": "Do you like growing plants? Alaska leads the nation in preservation of plant species through seed storage. Grow the plants at home, havest the seeds and send em in!",
      "image": {},
      "cost": "Volunteer",
  ...
  "posts": [
    {
      ...
      "description": "Seeking logging survey manager, outdoor skills required, including map reading, and land nav. Contact me ASAP. Multiple positions available. Must be willing to spend up to two weeks in the field at a time.",
      "image" : {},
      "cost": "$35/hour",
      "city": "Eureka",
      "postedBy": {
    ...
    },
    {
			...
			"title" : "Vets Who Code",
			"description" : "Vets Who Code now screening for potential apprentice positions. Must have interest in computers and a drive to learn new things. Program focus will be on web development. Send me a message ASAP if interested.",
			"image" : {},
			"cost" : "apprentice",
			"city" : "San Jose",
    ...
    },
    {
			...
			"title" : "Smart TV",
			"description" : "free tv if enlisted member of the 416th or 412th (or even op command I suppose, stop by Officers Quarters #687. First come first serve. ",
			"image" : {},
  ...
  "posts" : [
		{
			...
			"description" : "free dishwasher, you haul it out. Works okay just older and doesn't fit my taste. ",
			"image" : {},
			"cost" : "Free",
			"city" : "Billings",
			"postedBy" : {"$oid": "64ad770db9387952675642f6"},
    ...
    },
    {
			...
			"description" : "Wednesday from 8PM - 9PM at the Vet Center on 9th and Main. All veterans and spouses welcome. Free onsite child care every other week. Just show up or message me for details",
			"image" : {},
			"cost" : "Free",
			"city" : "Great Falls",
